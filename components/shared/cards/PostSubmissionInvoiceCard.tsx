...
interface PostSubmissionInvoiceCardProps {
  invoice: Invoice;
  onViewDetails?: () => void;
  onAction?: () => void;
  actionLabel?: string;
...
/**
 * PostSubmissionInvoiceCard Component
 * 
 * A card component for displaying post-submission invoice information with expandable details.
 * Used for invoices that have been sent (sent/viewed status).
 */
export function PostSubmissionInvoiceCard({ 
  invoice, 
  onViewDetails, 
  onAction,
  actionLabel,
  ...
  className 
}: PostSubmissionInvoiceCardProps) {
